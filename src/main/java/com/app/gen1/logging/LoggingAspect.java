...
public class LoggingAspect {
	...
	@Pointcut("execution(* com.app.gen1.controller.*.*(..)) || execution(* com.app.gen1.services.*.*(..)) || execution(* com.app.gen1.dao.*.*(..))")
	private void selectAll() {
	}

	@AfterReturning(pointcut = "execution(* com.app.gen1.controller.*.*(..))", returning = "retVal")
	...
	@Pointcut("execution(* com.app.gen1.controller.*.*(..))")
